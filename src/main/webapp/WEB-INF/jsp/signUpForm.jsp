...
<form:form modelAttribute="user" cssClass="box" method="post" enctype="multipart/form-data" autocomplete="off">
  ...
  <form:input path="userName" size = "20" maxlength="20" cssClass="text" placeholder="User Name" required="required"/>
  ...
  <form:input type="number" path="userContact" size = "20" maxlength="20" cssClass="number" placeholder="Contact Number" required="required" onblur="validateContact()"/>
